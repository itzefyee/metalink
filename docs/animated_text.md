...
import { DEFAULT_CAD_PROMPTS } from './prompts';
    ...
    <div className={`${className}`}>
      ...
      >
        <div className="flex items-start space-x-2">
          <span className="text-accent text-2xl md:text-3xl font-mono flex-shrink-0">
          </span>
          <div className="flex-1">
            <p className="text-xl md:text-2xl lg:text-3xl font-medium text-text">
              {displayedText}
              {!prefersReducedMotion && (
                <motion.span
